...
import org.jscc.app.client.biojava3.structure.io.MMCIFFileReader;
import org.jscc.app.client.biojava3.structure.io.StructureIOFile;
	...
	private void endLineChecks(String category,List<String> loopFields, List<String> lineData ) throws IOException{
		...
		if ( category.equals("_entity")){
			...
			Entity e =  (Entity) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.Entity",
					loopFields,lineData);
			triggerNewEntity(e);
			...
			struct =  (Struct) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.Struct",
					loopFields, lineData);

		} else if ( category.equals("_atom_site")){

			AtomSite a = (AtomSite) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.AtomSite",
					loopFields, lineData);
			triggerNewAtomSite(a);

		} else if ( category.equals("_database_PDB_rev")){
			DatabasePDBrev dbrev = (DatabasePDBrev) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.DatabasePDBrev",
					loopFields, lineData);
			...
			DatabasePDBremark remark = (DatabasePDBremark) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.DatabasePDBremark",
					loopFields, lineData);
			...
			Exptl exptl  = (Exptl) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.Exptl",
					loopFields,lineData);
			...
			StructRef sref  = (StructRef) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.StructRef",
					loopFields,lineData);
			...
			StructRefSeq sref  = (StructRefSeq) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.StructRefSeq",
					loopFields,lineData);

			triggerNewStrucRefSeq(sref);
		} else if ( category.equals("_entity_poly_seq")){
			EntityPolySeq exptl  = (EntityPolySeq) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.EntityPolySeq",
					loopFields,lineData);
			...
			StructAsym sasym  = (StructAsym) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.StructAsym",
					loopFields,lineData);
			...
			PdbxPolySeqScheme ppss  = (PdbxPolySeqScheme) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.PdbxPolySeqScheme",
					loopFields,lineData);
			...
			PdbxNonPolyScheme ppss  = (PdbxNonPolyScheme) buildObject(
					"org.jscc.app.client.biojava3.structure.io.mmcif.model.PdbxNonPolyScheme",
					loopFields,lineData);
