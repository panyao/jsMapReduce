...
// workaround with a cast => don't know if exact enough
	  return hash(seed, (int) (f));
  }
...
//    return hash(seed, Double.doubleToLongBits(d));
  ...
  public static int hash(int seed, Object o) {
    ...
    //Otherwise loop &
    	...
    	List<Object> gwtCapableArray = Arrays.asList(o);
//      int length = Array.getLength(o);
    	int length = gwtCapableArray.size();
...
//      }
    	...
    	for (int i = 0; i<length; i++) {
    		Object item = gwtCapableArray.get(i);
