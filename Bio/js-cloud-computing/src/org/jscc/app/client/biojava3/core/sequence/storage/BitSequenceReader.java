...
import org.jscc.app.client.biojava3.core.sequence.storage.BitSequenceReader.BitArrayWorker;
...
//        throw new UnsupportedOperationException(getClass().getSimpleName() + " is an immutable data structure; cannot reset contents");
    	throw new UnsupportedOperationException("is an immutable data structure; cannot reset contents");
    }
